...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .btn-search:hover {
                background-color: yellow; /* Change to desired hover background color */
            }

            /* Optional: Adjust the form control styles */
            .form-control {
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="staffDropdown">
                            ...
                            <a class="dropdown-item" href="staff?action=liststaff">Staff List</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="staffDropdown">
                            ...
                            <a class="dropdown-item" href="SellServlet?action=list">Sell Report</a>
                        </div>
                    </li>
                    <li class="nav-item">
